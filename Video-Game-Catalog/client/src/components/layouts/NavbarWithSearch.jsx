...
export function NavbarWithSearch() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <div className="!absolute left-3 top-[13px]" style={{ top: '10px' }}>
          <svg
            width="13"
            height="10"
            viewBox="0 0 13 10"
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          <div className="relative flex w-full gap-2 md:w-max">
            <Input
              ...
              className=" !border-t-blue-gray-300 pl-9 placeholder:text-blue-gray-300 focus:!border-blue-gray-300 file mt-0.5 pt-1.5 pb-1 mb-3"
              labelProps={{
                className: "before:content-none after:content-none",
              }}
            />
            <div className="!absolute left-3 top-[13px] mt-2">
              <svg
                width="13"
                height="14"
                viewBox="0 0 14 15"
          ...
          <Button size="md" className="rounded-lg mt-1">
            Search
          </Button>
        </div>
        <IconButton
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            ...
            <Button size="md" className="ml-2 mt-1 rounded-lg sm:mt-0">
              Search
            </Button>
          </div>
        </div>
...
Usage: HTML is the standard markup language used for creating web pages and web applications. It structures the web content.
Syntax: HTML uses tags (like <div>, <span>, <a>, etc.) to structure content.
Interactivity: HTML by itself is static and is used for the layout and structure. It doesn't have logic-building capabilities.
Integration: To create dynamic content in HTML, you would need to use a scripting language such as JavaScript.

* EJS (Embedded JavaScript):
Usage: EJS is a templating language that lets you generate HTML markup with plain JavaScript. It is primarily used on the server side.
Syntax: EJS uses <% %> tags to embed JavaScript within HTML. Inside these tags, you can write JavaScript code which will be run on the server before sending the HTML to the client.
Interactivity: EJS is used to create HTML with dynamic content. The data can be passed to the template, and it will generate HTML based on that data.
Integration: EJS templates are often used with Node.js on the server side.

* JSX (JavaScript XML):
Usage: JSX is a syntax extension for JavaScript, most commonly used with React, a JavaScript library for building user interfaces.
Syntax: JSX allows you to write HTML-like syntax in your JavaScript code. React then transforms this JSX into HTML.
Interactivity: JSX is highly interactive and dynamic since it combines the UI templates and the JavaScript logic.
Integration: JSX is a part of React components and is processed by React's reconciliation engine to create a virtual DOM. It’s client-side (although it can be rendered server-side too with tools like Next.js).
 */